...
void BOARD_InitDEBUG_UARTPins(void) {
	...
	PORT_SetPinConfig(BOARD_INITDEBUG_UARTPINS_DEBUG_UART_RX_PORT,
	...
	PORT_SetPinConfig(BOARD_INITDEBUG_UARTPINS_DEBUG_UART_TX_PORT,
...
void BOARD_InitSWD_DEBUGPins(void) {
	...
	PORT_SetPinConfig(BOARD_INITSWD_DEBUGPINS_DEBUG_SWD_SWDIO_PORT,
	...
	PORT_SetPinConfig(BOARD_INITSWD_DEBUGPINS_DEBUG_SWD_SWDCLK_PORT,
	...
	PORT_SetPinConfig(BOARD_INITSWD_DEBUGPINS_DEBUG_SWD_SWO_PORT,
...
void BOARD_InitLEDsPins(void) {
	...
	GPIO_PinInit(BOARD_INITLEDSPINS_LED_BLUE_GPIO,
			BOARD_INITLEDSPINS_LED_BLUE_PIN, &LED_BLUE_config);
	...
	PORT_SetPinConfig(BOARD_INITLEDSPINS_LED_RED_PORT,
			BOARD_INITLEDSPINS_LED_RED_PIN, &LED_RED);
	...
	PORT_SetPinConfig(BOARD_INITLEDSPINS_LED_GREEN_PORT,
			BOARD_INITLEDSPINS_LED_GREEN_PIN, &LED_GREEN);
	...
	PORT_SetPinConfig(BOARD_INITLEDSPINS_LED_BLUE_PORT,
			BOARD_INITLEDSPINS_LED_BLUE_PIN, &LED_BLUE);
}
...
void BOARD_InitBUTTONsPins(void) {
	...
	GPIO_PinInit(BOARD_INITBUTTONSPINS_SW3_GPIO, BOARD_INITBUTTONSPINS_SW3_PIN,
			&SW3_config);

	gpio_pin_config_t SW2_config = { .pinDirection = kGPIO_DigitalInput,
			.outputLogic = 0U };
	/* Initialize GPIO functionality on pin PIO0_23 (pin B7)  */
	GPIO_PinInit(BOARD_INITBUTTONSPINS_SW2_GPIO, BOARD_INITBUTTONSPINS_SW2_PIN,
			&SW2_config);
	...
	PORT_SetPinConfig(BOARD_INITBUTTONSPINS_SW2_PORT,
			BOARD_INITBUTTONSPINS_SW2_PIN, &SW2);
	...
	PORT_SetPinConfig(BOARD_INITBUTTONSPINS_SW3_PORT,
			BOARD_INITBUTTONSPINS_SW3_PIN, &SW3);
}
...
/* **********************************************************************************************************************
 *
 * Ethernet Pin and Peripheral Initialization
 *
 * Description : Configures the Ethernet-related pins, clock routing, and peripheral settings
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : Etharnet_InitPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
...
void WWDTclk_Init() {
	 ...
	 /* 1. Set clock divider for WWDT clock source using the reference project token */
	    CLOCK_SetClkDiv(kCLOCK_DivWdt0Clk, 1U);

	    /* 2. Gate on the clock to the WWDT peripheral block instance */
	    CLOCK_EnableClock(kCLOCK_Wwdt0);

	    /* 3. Enable FRO 1M clock source logic for WWDT module */
